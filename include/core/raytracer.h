...
private:
	...
	Vec3f clamp(Vec3f& x);
	Vec3f calculateSpecular(const Material& mat, 
	...
	Vec3f calculateReflectance(const Scene& scene, const Ray& ray, const Vec3f& intersectionPoint, const Vec3f& normal, const Material& mat, const int& depth);
};
